  ...
  const summaryCards = [
    {
      ...
      icon: <img src={iconTotalFeedback} className={style.cardIcon} alt="" />,
      bgColor: "#E3F2FD",
      iconColor: "#1976D2"
    },
    {
      ...
      icon: <img src={iconTurnAround} className={style.cardIcon} alt="" />,
      bgColor: "#E8F5E8",
      iconColor: "#4CAF50"
    },
    {
      ...
      icon: <img src={iconOverdue} className={style.cardIcon} alt="" />,
      bgColor: "#FFF3E0",
      iconColor: "#FF9800"
    },
    {
      ...
      icon: <img src={iconOpenIssues} className={style.cardIcon} alt="" />,
      bgColor: "#FFEBEE",
      iconColor: "#F44336"
    }
  ];
