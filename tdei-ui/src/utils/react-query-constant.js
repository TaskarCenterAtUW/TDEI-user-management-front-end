...
export const POST_CREATE_REFERRAL = "POST_CREATE_REFERRAL";
export const GET_SYSTEM_CAPABILITIES = "GET_SYSTEM_CAPABILITIES";
export const CREATE_QUALITY_REPORT_JOB = "POST_CREATE_JOB";
