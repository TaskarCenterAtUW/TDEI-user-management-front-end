...
const Referral = () => {
    ...
    useEffect(() => {
        // In real implementation, fetch codes from API using the project group ID (id)
        // For now, we use mock data
       console.log("Fetching referral codes for project group ID:", id);
    }, [id]);
    ...
    const handleNewCode = () => {
        window.location.href = "/referral-codes/new";
    };

    const handleEdit = (code) => {
        window.location.href = `/referral-codes/${code.id}/edit`;
    };
        ...
        <div className={style.jobsContainer}>
            ...
            <div className={style.header}>
                <div className="titleBlock">
                    ...
                    <div className="page-header-subtitle">Manage and track your referral and invite codes</div>
                </div>
                ...
                <div className={style.actionsRight}>
                    ...
                    <RBButton className={style.filterBtn} variant="outline-secondary" onClick={handleRefresh} disabled={isLoading}>
                        {isLoading ? (
            ...
            {showFilters && (
                <div className="mb-3" style={{ border: "1px dashed #ddd", padding: 12, borderRadius: 8 }}>
