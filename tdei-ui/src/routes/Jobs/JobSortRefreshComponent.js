...
import style from "./../Datasets/Datasets.module.css";
import sort from "./../../assets/img/sort.svg"
import { IconButton } from '@mui/material';
import refreshBtn from "./../../assets/img/refreshBtn.svg"

const JobSortRefreshComponent = ({ handleRefresh, handleDropdownSelect, isReleasedDataset }) => {
  return (
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="">
          <Dropdown onSelect={handleDropdownSelect}>
            <Dropdown.Toggle id="dropdown-basic" className={style.jobDropdownToggleSort}>
...
export default JobSortRefreshComponent;